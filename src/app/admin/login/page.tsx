...
function LoginFormSkeleton() {
  return (
    <Card className="border-pine-200 dark:border-pine-800 shadow-xl">
      <CardHeader className="text-center pb-4">
        <div className="w-24 h-6 bg-muted rounded-full mx-auto mb-4 animate-pulse" />
        <div className="w-40 h-8 bg-muted rounded mx-auto mb-2 animate-pulse" />
        <div className="w-56 h-4 bg-muted rounded mx-auto animate-pulse" />
      </CardHeader>
